...
(function() {
	var JavaEditor = coos.createClass(coos.Editor);
	coos.Editor.Java = JavaEditor;
...
(function() {
	var BeanEditor = coos.createClass(coos.Editor);
	coos.Editor.Bean = BeanEditor;
...
(function() {
	var AttributeEditor = coos.createClass(coos.Editor);
	coos.Editor.Attribute = AttributeEditor;
