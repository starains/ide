package com.teamide.ide.generater.resources;
...
import com.teamide.ide.generater.Generater;
...
public class ResourcesGenerater extends Generater {
	...
	public ResourcesGenerater(RepositoryProcessorParam param, AppBean app, AppContext context) {
