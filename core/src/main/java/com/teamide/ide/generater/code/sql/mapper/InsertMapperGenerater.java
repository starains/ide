...
public class InsertMapperGenerater extends SqlMapperGenerater {

	protected final Insert insert;

	public InsertMapperGenerater(String factory_classname, Insert insert) {
	...
	public void appendColumnSql(int tab, InsertColumn column) {
		if (ObjectUtil.isTrue(column.getCustom())) {
			...
			content.append(getTab(tab)).append(customsql).append("\n");
			return;
		}
