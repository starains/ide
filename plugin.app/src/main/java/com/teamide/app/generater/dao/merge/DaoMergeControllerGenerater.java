...
public class DaoMergeControllerGenerater extends BaseMergeGenerater {
	...
	public DaoMergeControllerGenerater(String directory, List<DaoBean> daos, File sourceFolder, AppBean app,
			AppContext context) {
	...
	public void buildData() {
		...
		for (DaoBean dao : daos) {
			DaoControllerGenerater generater = new DaoControllerGenerater(dao, sourceFolder, app, context);
			generater.init();
			try {
