...
public class ServiceMergeGenerater extends BaseMergeGenerater {
	...
	public ServiceMergeGenerater(String directory, List<ServiceBean> services, File sourceFolder, AppBean app,
			AppContext context) {
	...
	public void buildData() {
		...
		for (ServiceBean service : services) {
			...
			if (isImpl()) {
				...
				generater = new ServiceGenerater(service, sourceFolder, app, context);
			}
			generater.init();
			try {
